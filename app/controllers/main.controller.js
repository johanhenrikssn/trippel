(function() {
    ...
    function mainController($scope) { 
        ...
        },
        {
            ...
            description: "Exjobbaren programmerade delar i projektet Open Space på NASA tillsammans med Linköpings Universitet. Programmet ska kunna visa och flyga omkring i vårt universum i 3D med till exempel planeter, solstormar, stjärnor och rymdfarkoster.",
            color: "#5BA675",
